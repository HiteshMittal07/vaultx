...
export function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[#050505] text-white selection:bg-emerald-500/30">
      ...
      <GlassSphere
        className="top-20 left-10 h-32 w-32 md:h-48 md:w-48"
        delay={0.2}
      />
      <GlassSphere
        className="top-40 right-20 h-24 w-24 md:h-32 md:w-32"
        delay={0.4}
      />
      <GlassSphere
        className="bottom-20 left-1/5 h-40 w-40 md:h-56 md:w-56"
        delay={0.6}
      />
      <GlassSphere
        className="bottom-10 right-10 h-64 w-64 opacity-50"
        delay={0.8}
      />
      ...
      <section className="relative flex min-h-screen w-full flex-col items-center justify-center px-4 text-center overflow-hidden z-0">
        ...
        >
          ...
          >
            [ Empowering financial freedom: Instant swaps, smart borrowing, and
            decentralized financial services with our innovative Vault platform
            ]
          </motion.p>
        ...
        <div
          className="absolute left-8 top-1/2 hidden -translate-y-1/2 rotate-180 text-xs tracking-widest text-zinc-600 md:block"
